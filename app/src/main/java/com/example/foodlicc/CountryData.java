...
public class CountryData {
    public static final String[] countryNames = {"Algeria", "Afghanistan", "Albania",
             "Andorra", "Angola", "Antarctica", "Argentina",
    ...
    public static final String[] countryAreaCodes = {"213", "93", "355",
